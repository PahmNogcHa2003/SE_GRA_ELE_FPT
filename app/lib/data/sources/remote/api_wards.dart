import 'dart:convert';
import 'package:hola_bike_app/application/usecases/usecase_get_provice-info.dart';
...
class WardsApi {
  ...
  Future<List<Province>> GetWardByProvice(String code) async {
    final url = Uri.parse('$baseUrl/Locations/provinces/$code/wards');
