...
//        {
//            // === 1. Mock UnitOfWork & các Service khác ===
...
//            // === 3. Mock SignInManager (không khởi tạo thật) ===
...
//            // === 4. Khởi tạo AuthService với mocks ===
...
//            _mockUow.Verify(u => u.CommitTransactionAsync(It.IsAny<IDbContextTransaction>(), It.IsAny<CancellationToken>()), Times.Once);
//        }
